...
| 3 | `cp5_occlusion`, người che một phần motorcycle | Có thể tách phần xe ở hai phía người thành hai object hoặc tô nối qua người | Giữ các phần nhìn thấy thuộc cùng một instance `motorcycle`, không tô lên `person` và không đoán phần bị che. |# Báo cáo Day 5 — điền trực tiếp trong fork của bạn
